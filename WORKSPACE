...
http_archive(
    ...
    patch_args = ["-p1"],
    patches = ["//re_core/third_party/googletest:googletest.patch"],
...
http_archive(
    name = "libeigen",
    build_file = "//re_core/third_party/eigen:eigen.BUILD",
...
http_archive(
    name = "lz4",
    build_file = "//re_core/third_party/lz4:lz4.BUILD",
...
http_archive(
    name = "zstd",
    build_file = "//re_core/third_party/zstd:zstd.BUILD",
...
http_archive(
    name = "mcap",
    build_file = "//re_core/third_party/mcap:mcap.BUILD",
...
http_archive(
    ...
    build_file = "//re_core/third_party/foxglove_schemas:schemas.BUILD",
...
http_archive(
    name = "fmt",
    build_file = "//re_core/third_party/fmt:fmt.BUILD",
...
http_archive(
    name = "httplib",
    build_file = "//re_core/third_party/httplib:httplib.BUILD",
...
http_archive(
    name = "pmp",
    build_file = "//re_core/third_party/pmp:pmp.BUILD",
...
http_archive(
    name = "libccd",
    build_file = "//re_core/third_party/libccd:libccd.BUILD",
    patch_args = ["-p1"],
    # Patch to generate files ordinarily generated by cmake:
    patches = ["//re_core/third_party/libccd:libccd.patch"],
...
http_archive(
    name = "fcl",
    build_file = "//re_core/third_party/fcl:fcl.BUILD",
    patch_args = ["-p1"],
    # Patch to generate files ordinarily generated by cmake:
    patches = ["//re_core/third_party/fcl:fcl.patch"],
...
http_archive(
    name = "flamegraph",
    build_file = "//re_core/third_party/flamegraph:flamegraph.BUILD",
...
http_archive(
    name = "indicators",
    build_file = "//re_core/third_party/indicators:indicators.BUILD",
...
http_archive(
    ...
    build_file = "//re_core/third_party/nlohmann_json:nlohmann_json.BUILD",
