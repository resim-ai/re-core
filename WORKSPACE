...
http_archive(
    ...
    patch_args = ["-p1"],
    patches = ["//resim/third_party/googletest:googletest.patch"],
...
http_archive(
    name = "libeigen",
    build_file = "//resim/third_party/eigen:eigen.BUILD",
...
http_archive(
    name = "fmt",
    build_file = "//resim/third_party/fmt:fmt.BUILD",
...
http_archive(
    name = "httplib",
    build_file = "//resim/third_party/httplib:httplib.BUILD",
